...
\subsubsection{树分治}
\label{sec:org42734cf}
\begin{enumerate}
\item 点分治
\label{sec:org81701f8}

点分治可以以 \(log(n)\)的代价统计树上所有两点之间的路径。
\end{enumerate}
\subsubsection{最近公共祖先}
\label{sec:org7ce65e4}
\begin{enumerate}
\item 倍增
\label{sec:orgf0375d6}
...
\subsubsection{构造}
\label{sec:org6d6f96e}

\begin{enumerate}
\item 倍增法
\label{sec:orgfaf5d18}
